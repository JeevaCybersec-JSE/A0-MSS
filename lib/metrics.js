...
const METRICS = [
  ...
  // ---------------- Email & Phishing ----------------
  { id: 'user_reported_phishing', section: 'email', label: 'User-reported phishing', direction: '', target: null, mode: 'direct', unit: '', desc: 'Messages reported by users via the report button' },
